...

{
    ...
    static {
		...
		modMap.put(SharedMonsterAttributes.KNOCKBACK_RESISTANCE, new AttributeModifier(KNOCKBACK_RESISTANCE_AMAZONITEBODY_UUID, "KNOCKBACK_RESISTANCE_AMAZONITEBODY_UUID", 14, 0));
	}
   @Override
    public Multimap<String, AttributeModifier> getAttributeModifiers(EntityEquipmentSlot slot,
    	...
    	if (slot==EntityEquipmentSlot.CHEST) {
    		...
    		mods.put(knockback, new AttributeModifier (KNOCKBACK_RESISTANCE_AMAZONITEBODY_UUID, "KNOCKBACK_RESISTANCE_AMAZONITEBODY_UUID", 14, 0));
