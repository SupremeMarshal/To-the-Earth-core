...
public class HardnessHandler 
{
	...
	public static void executeProcedure(java.util.HashMap<String, Object> dependencies) {
		...
		if (block == ModBlocks.STIFFROCK || block == ModBlocks.STIFFROCK_COAL || block == ModBlocks.STIFFROCK_SULFUR || block == ModBlocks.STIFFROCK_REDSTONE || block == ModBlocks.STIFFROCK_LAPIS 
		    		...
		    		|| block = ModBlocks.STIFFROCK_TOPAZ || block == ModBlocks.STIFFROCK_DIAMOND || block == ModBlocks.STIFFROCK_JADE || block == ModBlocks.STIFFROCK_AMAZONITE || block == ModBlocks.STIFFROCK_AMETHYST || block == ModBlocks.STIFFROCK_ONYX)
		{hardness = 0;}
			 	...
			 	|| block == ModBlocks.HARDROCK_TOPAZ || block == ModBlocks.HARDROCK_DIAMOND || block == ModBlocks.HARDROCK_JADE || block == ModBlocks.HARDROCK_AMAZONITE || block == ModBlocks.HARDROCK_AMETHYST || block == ModBlocks.HARDROCK_ONYX)
		{hardness = 1;}
			 	...
			 	|| block == ModBlocks.HARDERROCK_TOPAZ || block == ModBlocks.HARDERROCK_DIAMOND || block == ModBlocks.HARDERROCK_JADE || block == ModBlocks.HARDERROCK_AMAZONITE || block == ModBlocks.HARDERROCK_AMETHYST || block == ModBlocks.HARDERROCK_ONYX)
		{hardness = 2;}
			 	...
			 	|| block == ModBlocks.REDROCK_TOPAZ || block == ModBlocks.REDROCK_DIAMOND || block == ModBlocks.REDROCK_JADE || block == ModBlocks.REDROCK_AMAZONITE || block == ModBlocks.REDROCK_AMETHYST || block == ModBlocks.REDROCK_ONYX)
		{hardness = 3;}
			 	...
			 	|| block == ModBlocks.MANTLEROCK_TOPAZ || block == ModBlocks.MANTLEROCK_DIAMOND || block == ModBlocks.MANTLEROCK_JADE || block == ModBlocks.MANTLEROCK_AMAZONITE || block == ModBlocks.MANTLEROCK_AMETHYST || block == ModBlocks.MANTLEROCK_ONYX)
		{hardness = 4;}
			 	...
			 	|| block == ModBlocks.LOWER_MANTLEROCK_TOPAZ || block == ModBlocks.LOWER_MANTLEROCK_DIAMOND || block == ModBlocks.LOWER_MANTLEROCK_JADE || block == ModBlocks.LOWER_MANTLEROCK_AMAZONITE || block == ModBlocks.LOWER_MANTLEROCK_AMETHYST || block == ModBlocks.LOWER_MANTLEROCK_ONYX)
		{hardness = 5;}
			 	...
			 	|| block == ModBlocks.COREROCK_TOPAZ || block == ModBlocks.COREROCK_DIAMOND || block == ModBlocks.COREROCK_JADE || block == ModBlocks.COREROCK_AMAZONITE || block == ModBlocks.COREROCK_AMETHYST || block == ModBlocks.COREROCK_ONYX)
		{hardness = 6;}
			 	...
			 	|| block == ModBlocks.INNERCOREROCK_TOPAZ || block == ModBlocks.INNERCOREROCK_DIAMOND || block == ModBlocks.INNERCOREROCK_JADE || block == ModBlocks.INNERCOREROCK_AMAZONITE || block == ModBlocks.INNERCOREROCK_AMETHYST || block == ModBlocks.INNERCOREROCK_ONYX)
		{hardness = 7;}
		else
		{hardness = -1;}
		...
		{tier = 4;}
		else if (block == ModBlocks.TOPAZ_ORE || block == ModBlocks.STIFFROCK_TOPAZ || block == ModBlocks.HARDROCK_TOPAZ || block == ModBlocks.HARDERROCK_TOPAZ || block == ModBlocks.REDROCK_TOPAZ || block == ModBlocks.MANTLEROCK_TOPAZ || block == ModBlocks.LOWER_MANTLEROCK_TOPAZ || block == ModBlocks.COREROCK_TOPAZ || block == ModBlocks.INNERCOREROCK_TOPAZ)
		{tier = 4;}
