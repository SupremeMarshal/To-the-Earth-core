...
public class HardnessHandler 
{
	...
	public static void executeProcedure(java.util.HashMap<String, Object> dependencies) {
		...
		{hardness = 1;}
		else if (block == ModBlocks.HARDERROCK || block == ModBlocks.HARDERROCK_COAL || block == ModBlocks.HARDERROCK_IRON || block == ModBlocks.HARDERROCK_REDSTONE
				|| block == ModBlocks.HARDERROCK_LAPIS || block == ModBlocks.HARDERROCK_EMERALD || block == ModBlocks.HARDERROCK_ONYX || block == ModBlocks.HARDERROCK_SILVER
				|| block == ModBlocks.HARDERROCK_GOLD || block == ModBlocks.HARDERROCK_PLATINUM || block == ModBlocks.HARDERROCK_SAPHIR
				|| block == ModBlocks.HARDERROCK_RUBY || block == ModBlocks.HARDERROCK_DIAMOND || block == ModBlocks.HARDERROCK_AMAZONITE || block == ModBlocks.HARDERROCK_SULFUR)
		{hardness = 2;}
		...
		{hardness = 4;}
		else if (block == ModBlocks.LOWER_MANTLEROCK || block == ModBlocks.LOWER_MANTLEROCK_COAL || block == ModBlocks.LOWER_MANTLEROCK_IRON || block == ModBlocks.LOWER_MANTLEROCK_REDSTONE
				|| block == ModBlocks.LOWER_MANTLEROCK_LAPIS || block == ModBlocks.LOWER_MANTLEROCK_EMERALD || block == ModBlocks.LOWER_MANTLEROCK_ONYX || block == ModBlocks.LOWER_MANTLEROCK_SILVER  || block == ModBlocks.HOT_LOWER_MANTLEROCK
				|| block == ModBlocks.LOWER_MANTLEROCK_GOLD || block == ModBlocks.LOWER_MANTLEROCK_PLATINUM || block == ModBlocks.LOWER_MANTLEROCK_SAPHIR
				|| block == ModBlocks.LOWER_MANTLEROCK_RUBY || block == ModBlocks.LOWER_MANTLEROCK_DIAMOND || block == ModBlocks.LOWER_MANTLEROCK_AMAZONITE || block == ModBlocks.LOWER_MANTLEROCK_SULFUR)
		{hardness = 5;}
