...
public class HardnessHandler 
{
	...
	public static void executeProcedure(java.util.HashMap<String, Object> dependencies) {
		...
		if (block == ModBlocks.HARDROCK_GOLD || block == ModBlocks.REDROCK_GOLD || block == ModBlocks.MANTLEROCK_GOLD || block == ModBlocks.GOLD_ORE || block == ModBlocks.HARDROCK_EMERALD 
				...
				|| block == ModBlocks.HARDROCK_REDSTONE  || block == ModBlocks.REDROCK_REDSTONE || block == ModBlocks.MANTLEROCK_REDSTONE || block == ModBlocks.IRON_BLOCK)
		{tier = 1;}
		...
		{tier = 0;}
			...
			{
				if ((int)hardness == -1 && (int)tier == 0) { block.setHardness((float) 20.0F);}
			...
			{
				if ((int)hardness == -1 && (int)tier == 0) { block.setHardness((float) 10.0F);}
				else { block.setHardness((float) -1.0F);}
		...
		{
			if ((int)hardness == -1 && (int)tier == 0) { block.setHardness((float) 7.3F);}
			...
			else if ((int)hardness == 0 && (int)tier == 0) { block.setHardness((float) 0.5F);}
			...
			if (block == ModBlocks.IRON_BLOCK) { block.setHardness(3.0f);}
